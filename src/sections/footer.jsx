  ...
  return (
    <footer id='footer' className='footer'>
      ...
      <div className='footerBase'>
        <a href='/impressum' className='svg impress' aria-label='Impressum öffnen'>
          <h3>Impressum</h3>
          <svg className='svgImpress' width='225' height='70' viewBox='0 0 208 76' fill='none' xmlns='http://www.w3.org/2000/svg'>
            <path
        ...
        <a href='https://www.linkedin.com/in/marius-hummel-471078187/' target='_blank' className='svg linked' aria-label='LinkedIn öffnen'>
          <h3>LinkedIn</h3>
        ...
        <a href='https://github.com/mfhum' target='_blank' className='svg github' aria-label='Github öffnen'>
          <h3>Github</h3>
